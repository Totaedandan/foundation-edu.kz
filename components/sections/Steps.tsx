...
export function Steps() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-16">
      <Reveal>
        <div className="text-2xl sm:text-3xl font-semibold">{t(lang, "steps_title")}</div>
      </Reveal>
      ...
      <div className="mt-10 hidden lg:block">
        <div className="relative">
          ...
          <div className="absolute left-0 right-0 top-5 h-px bg-gradient-to-r from-[#800020]/10 via-[#800020]/55 to-[#800020]/10" />
        ...
        {steps.map((s, idx) => (
          <Reveal key={s.title} delay={idx * 0.04}>
            <div className="relative pl-12">
              ...
              <motion.div whileHover={{ y: -2 }} className="glass rounded-3xl p-5">
                <div className="h-1 w-10 rounded-full bg-[#800020]" />
                <div className="mt-3 font-semibold">{t(lang, s.title)}</div>
                <div className="mt-2 text-sm text-muted">{t(lang, s.desc)}</div>
              </motion.div>
