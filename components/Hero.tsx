  ...
  return (
    <div className="relative overflow-hidden pt-16 sm:pt-20">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Harvard building — colored, premium tint; more visible on mobile + show more of building */}
        <Image
        ...
        <div className="absolute inset-0 bg-grid-soft opacity-[0.28] mix-blend-overlay [mask-image:radial-gradient(ellipse_at_center,black_20%,transparent_72%)]" />

        {/* burgundy blurs */}
        <div className="absolute -left-32 -top-44 h-[520px] w-[520px] sm:h-[560px] sm:w-[560px] rounded-full bg-[#800020]/20 blur-3xl" />
        <div className="absolute -right-32 top-24 h-[520px] w-[520px] sm:h-[560px] sm:w-[560px] rounded-full bg-[#800020]/14 blur-3xl" />
        <div className="absolute right-1/4 top-1/3 h-[240px] w-[240px] sm:h-[260px] sm:w-[260px] rounded-full bg-[#800020]/12 blur-3xl" />
        <div className="absolute left-1/2 -bottom-56 h-[460px] w-[460px] sm:h-[520px] sm:w-[520px] -translate-x-1/2 rounded-full bg-[#800020]/10 blur-3xl" />
      </div>

      <main className="mx-auto max-w-6xl px-4 pb-10 sm:pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start pt-5 sm:pt-8">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-24 order-1 lg:order-2">
            ...
            <Reveal delay={0.18}>
              <div className="mt-3 sm:mt-4 relative glass rounded-3xl overflow-hidden p-4 sm:p-5">
                <div className="text-[12px] sm:text-sm text-muted">{t(lang, "visual_note")}</div>

                <div className="mt-3 grid grid-cols-3 gap-2">
                  <div className="relative aspect-[3/4] rounded-2xl overflow-hidden">
                    <Image src="/images/p10_335_0941121d80.jpg" alt="" fill className="object-cover" />
                  </div>
                  <div className="relative aspect-[3/4] rounded-2xl overflow-hidden">
                    <Image src="/images/p9_318_5ba8126ab5.jpg" alt="" fill className="object-cover" />
                  </div>
                  <div className="relative aspect-[3/4] rounded-2xl overflow-hidden">
                    <Image src="/images/p7_258_0b94c9c2c1.jpg" alt="" fill className="object-cover" />
                  </div>
                </div>
          ...
          <div className="lg:col-span-7 order-2 lg:order-1">
            ...
            <Reveal delay={0.05}>
              <h1 className="mt-3 sm:mt-4 text-[30px] leading-[1.12] sm:text-5xl font-semibold">
                {t(lang, "hero_title")}
              </h1>
            </Reveal>

            <Reveal delay={0.1}>
              <p className="mt-3 sm:mt-4 text-[15px] sm:text-lg text-muted max-w-xl">
                {t(lang, "hero_sub")}
              </p>
            </Reveal>
            ...
            <Reveal delay={0.12}>
              <div className="mt-4 sm:mt-5 flex flex-wrap items-center gap-2">
                <div className="accent inline-flex items-center gap-2 rounded-full px-3 py-1 text-[12px] sm:text-sm">
                  ...
                  <span className="text-[12px] sm:text-sm text-white">{t(lang, "hero_badge_1")}</span>
                </div>
            ...
            <Reveal delay={0.15}>
              <div className="mt-5 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div className="glass rounded-2xl p-3.5 sm:p-4">
                  ...
                  <div className="text-sm text-muted mt-1">{t(lang, "hero_card1_p")}</div>
                </div>

                <div className="glass rounded-2xl p-3.5 sm:p-4">
                  <div className="font-semibold">{t(lang, "hero_card2_t")}</div>
                  <div className="text-sm text-muted mt-1">{t(lang, "hero_card2_p")}</div>
                </div>
              </div>
            </Reveal>
              ...
              <div id="for" className="mt-6 sm:mt-8 glass rounded-3xl p-4 sm:p-6">
                ...
                <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3 text-sm">
                  <div className="rounded-2xl bg-white/5 p-3.5 sm:p-4 shadow-[0_16px_50px_rgba(0,0,0,0.35)]">
                    ...
                    <div className="text-muted mt-1">{t(lang, "for_1_p")}</div>
                  </div>

                  <div className="rounded-2xl bg-white/5 p-3.5 sm:p-4 shadow-[0_16px_50px_rgba(0,0,0,0.35)]">
                    <div className="font-semibold">{t(lang, "for_2_h")}</div>
                    <div className="text-muted mt-1">{t(lang, "for_2_p")}</div>
                  </div>

                  <div className="rounded-2xl bg-white/5 p-3.5 sm:p-4 shadow-[0_16px_50px_rgba(0,0,0,0.35)]">
                    <div className="font-semibold">{t(lang, "for_3_h")}</div>
                    <div className="text-muted mt-1">{t(lang, "for_3_p")}</div>
                  </div>
                </div>
              </div>
            </Reveal>
